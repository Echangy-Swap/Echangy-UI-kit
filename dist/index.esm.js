...
var Icon$Q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/e.png" })));
};
...
var Icon$x = function (props) {
    return (React.createElement(Svg, { xmlns: "http://www.w3.org/2000/svg", height: "24px", "fill-rule": "evenodd;", "clip-rule": "evenodd;", "stroke-linejoin": "round;", "stroke-miterlimit": "2;", version: "1.1", viewBox: "0 0 512 512", width: "24px" },
        React.createElement("path", { d: "M512,257.555c0,-141.385 -114.615,-256 -256,-256c-141.385,0 -256,114.615 -256,256c0,127.777 93.616,233.685 216,252.89l0,-178.89l-65,0l0,-74l65,0l0,-56.4c0,-64.16 38.219,-99.6 96.695,-99.6c28.009,0 57.305,5 57.305,5l0,63l-32.281,0c-31.801,0 -41.719,19.733 -41.719,39.978l0,48.022l71,0l-11.35,74l-59.65,0l0,178.89c122.385,-19.205 216,-125.113 216,-252.89Z", "fill-rule": "nonzero;" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: isDark ? '/images/e.png' : '/images/e.png' })));
};
...
var Icon$o = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "24 24 0 0" }, props),
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null, cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
            React.createElement(Icon$L, { width: "52px", mr: "8px" }),
            React.createElement(Text, { color: "textSubtle", bold: true, fontSize: "30px" }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
        React.createElement(SettingsEntry, null,
            React.createElement(Flex, { justifyContent: "space-around", style: { width: "100%" } }, socials.map(function (social, index) {
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React.createElement("div", { style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "space-around" } },
            React.createElement("div", { style: { cursor: "pointer" } },
                React.createElement("img", { src: "/images/binance.png", alt: "binance" }),
                React.createElement(Text, { style: { margin: "0.5rem 0 1rem 0" } }, "Binance")),
            React.createElement("div", { style: { cursor: "pointer" } },
                React.createElement("img", { src: "/images/polygon.png", alt: "polygon" }),
                React.createElement(Text, { style: { margin: "0.5rem 0 1rem 0" } }, "Polygon"))),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Flex, null,
        React.createElement(Button, { size: "sm", variant: "primary", onClick: function () {
                window.open(networkLink);
            } },
            React.createElement("img", { style: { width: "25px", height: "25px", marginRight: "5px" }, src: "/images/BNB.png", alt: "network" }),
            networkName),
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                React.createElement(UserBlock, { account: account, login: login, logout: logout, networkName: networkName, networkLink: networkLink }),
