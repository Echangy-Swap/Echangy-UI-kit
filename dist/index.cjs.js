...
var Icon$Q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/e.png" })));
};
...
var getBackgroundColor = function (_a) {
    ...
    return theme.colors[variant === variants$1.SUBTLE ? "card" : "tertiary"];
};
...
var Icon$x = function (props) {
    return (React__default['default'].createElement(Svg, { xmlns: "http://www.w3.org/2000/svg", height: "24px", "fill-rule": "evenodd;", "clip-rule": "evenodd;", "stroke-linejoin": "round;", "stroke-miterlimit": "2;", version: "1.1", viewBox: "0 0 512 512", width: "24px" },
        React__default['default'].createElement("path", { d: "M512,257.555c0,-141.385 -114.615,-256 -256,-256c-141.385,0 -256,114.615 -256,256c0,127.777 93.616,233.685 216,252.89l0,-178.89l-65,0l0,-74l65,0l0,-56.4c0,-64.16 38.219,-99.6 96.695,-99.6c28.009,0 57.305,5 57.305,5l0,63l-32.281,0c-31.801,0 -41.719,19.733 -41.719,39.978l0,48.022l71,0l-11.35,74l-59.65,0l0,178.89c122.385,-19.205 216,-125.113 216,-252.89Z", "fill-rule": "nonzero;" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React__default['default'].createElement("image", { width: "26", height: "26", href: isDark ? '/images/e.png' : '/images/e.png' })));
};
...
var Icon$o = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "24 24 0 0" }, props),
...
var socials = [
    ...
    },
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/echangyexchange" // "https://www.reddit.com/r/GooseFinanceofficial",
    },
    {
        label: "Medium",
        icon: "MediumIcon",
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
            React__default['default'].createElement(Icon$L, { width: "52px", mr: "8px" }),
            React__default['default'].createElement(Text, { color: "textSubtle", bold: true, fontSize: "30px" }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }))),
        React__default['default'].createElement(SettingsEntry, null,
            React__default['default'].createElement(Flex, { justifyContent: "space-around", style: { width: "100%" } }, socials.map(function (social, index) {
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React__default['default'].createElement("div", { style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "space-around" } },
            React__default['default'].createElement("div", { style: { cursor: "pointer" } },
                React__default['default'].createElement("img", { src: "/images/binance.png", alt: "binance" }),
                React__default['default'].createElement(Text, { style: { margin: "0.5rem 0 1rem 0" } }, "Binance")),
            React__default['default'].createElement("div", { style: { cursor: "pointer" } },
                React__default['default'].createElement("img", { src: "/images/polygon.png", alt: "polygon" }),
                React__default['default'].createElement(Text, { style: { margin: "0.5rem 0 1rem 0" } }, "Polygon"))),
...
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout, networkName = _a.networkName, networkLink = _a.networkLink;
    var _b = useWalletModal(login, logout, account), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(Button, { size: "sm", variant: "primary", onClick: function () {
                window.open(networkLink);
            } },
            React__default['default'].createElement("img", { style: { width: "25px", height: "25px", marginRight: "5px" }, src: "/images/BNB.png", alt: "network" }),
            networkName),
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children, networkName = _a.networkName, networkLink = _a.networkLink;
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, networkName: networkName, networkLink: networkLink }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { nav: "linear-gradient(180deg,#071c3c,#002b6f)", sidebar: "rgba(0, 41, 102, 1)", background: "rgb(7, 22, 45)", backgroundDisabled: "#E9EAEB", contrast: "rgba(0, 41, 102, 1)", invertedContrast: "rgba(0, 41, 102, 1)", input: "#26466D", tertiary: "#26466D", text: "#FFFFFF", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", borderColor: "#E9EAEB", card: "linear-gradient(235deg, rgb(51, 111, 245) 4.05%, rgba(17, 81, 225, 0.32) 103.52%)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { nav: "rgb(7, 22, 45)", sidebar: "#27262c", secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
